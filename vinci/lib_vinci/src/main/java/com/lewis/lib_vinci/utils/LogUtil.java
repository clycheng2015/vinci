...
public final class LogUtil {
    ...
    private static final boolean LOGV = LibConstants.DEBUG;
    private static final boolean LOGD = LibConstants.DEBUG;
    private static final boolean LOGI = LibConstants.DEBUG;
    private static final boolean LOGW = LibConstants.DEBUG;
    private static final boolean LOGE = LibConstants.DEBUG;
    /**
     * Debug开关
     */
    public static final boolean DEBUG = LibConstants.DEBUG;
